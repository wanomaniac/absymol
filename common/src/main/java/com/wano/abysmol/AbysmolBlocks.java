...
public class AbysmolBlocks {
    public static final Block BOOKSHELF_OF_HYMNS = register(
            "bookshelf_of_hymns",
            Block::new,
            BlockBehaviour.Properties.of().sound(SoundType.CHISELED_BOOKSHELF),
            true
    );

    public static final Block INFLAMMABLE_SYCAMORE_PLANKS = register(
            "inflammable_sycamore_planks",
            Block::new,
